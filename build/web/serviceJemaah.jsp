...
<html>
    <head>
        ...
        <title>Perkhidmatan Jemaah</title>
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="serviceJemaah.jsp">FPCI SYSTEM <em>.</em></a></div>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">Assalamualaikum <%=jemaah.getJemName()%> !</h1>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><% if (ft.format(dNow).equals("Sun") ||ft.format(dNow).equals("Mon") || ft.format(dNow).equals("Tue") || ft.format(dNow).equals("Wed") || ft.format(dNow).equals("Thu") || ft.format(dNow).equals("Fri")) {%>

                                    <a href="./menuMasjid.jsp?jemPos=<%=jemaah.getJemPoscode()%>&search2=<%=ft1.format(c.getTime())%>">
                                        <i style="color: black;" class="fas fa-edit"></i>
                                    </a><%} else {%>
                                    <a href=messageService.jsp>
                                        <i style="color: black;" class="fas fa-edit"></i>
                                    </a>
                                    <%}%>
                                </span>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href=infoListJem.jsp?id="<%=jemaah.getJemPoscode()%>">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href=jemaahInformation.jsp?id="<%=jemaah.getJemId()%>">
