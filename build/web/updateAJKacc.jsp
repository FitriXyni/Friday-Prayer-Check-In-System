...
<html>
    <head>
        ...
        <title>Kemaskini Profil AJK Masjid</title>
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=AJKInformation.jsp?id="<%=ajkmasjid.getAjkid()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font">Princian AJK Masjid</h3>
                                                    <form action="processUAjk.jsp" method="post">

                                                        <input type="hidden" name="ajkid" value="<%=ajkmasjid.getAjkid()%>">

                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Nama AJK Masjid:</label>
                                                                <input type="text" name="ajkname" value="<%=ajkmasjid.getAjkname()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Kata Laluan:</label>
                                                                <input type="text" name="ajkpass" value="<%=ajkmasjid.getAjkpass()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>No Kad Pengenalan:</label>
                                                                <input type="text" id="ajkic" name="ajkic" onblur="getIc()" value="<%=ajkmasjid.getAjkic()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Umur:</label>
                                                                <input type="text" name="ajkage" id="lblAge" value="<%=ajkmasjid.getAjkage()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Tarikh Lahir</label>
                                                                <input type="text" name="ajkdob" id="ajkdob" value="<%=ajkmasjid.getAjkdob()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Alamat:</label>
                                                                <input type="text" name="ajkalmt" value="<%=ajkmasjid.getAjkalmt()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Mukim:</label>
                                                                <input type="text" name="ajkmukim" value="<%=ajkmasjid.getAjkmukim()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Daerah:</label>
                                                                <input type="text" name="ajkdaerah" value="<%=ajkmasjid.getAjkdaerah()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>No Telefon:</label>
                                                                <input type="text" name="ajkntel" value="<%=ajkmasjid.getAjkntel()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <form action="AJKInformation.jsp">
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="hidden" name="id" value='"<%=ajkmasjid.getAjkid()%>"'>
