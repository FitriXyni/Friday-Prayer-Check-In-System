                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 style="text-align: center;" class="cursive-font">Kemaskini Lokasi Masjid</h1>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font">Perincian Lokasi Masjid</h3>
                                                    <form action="processUL.jsp" method="post">
                                                        
                                                        <input type="hidden" value="<%=lokasi.getLokasiId()%>" name="locId">

                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Nama Masjid:</label>
                                                                <input type="text" name="MasName" value="<%=lokasi.getNamaMasjid()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Latitud Masjid:</label>
                                                                <input type="latitude" name="latitude" value="<%=lokasi.getLatitude()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Longitud Masjid:</label>
                                                                <input type="text" name="longitude" value="<%=lokasi.getLongitude()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Poskod:</label>
                                                                <input type="text" name="poscode" value="<%=lokasi.getPoskod()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Daerah</label>
                                                                <input type="text" name="daerah" value="<%=pja.getPjaDaerah()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Mukim</label>
                                                                <input type="text" name="mukim" value="<%=pja.getPjaMukim()%>" class="form-control">
                                                            </div>
                                                        </div>
