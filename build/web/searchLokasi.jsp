...
<html>
    ...
    <%
        ...
        List<lokasi> locAll = lokDao.retrieveLocJemaah(Poskod);
    ...
    <body>
        ...
        <div id="page">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=infoListJem.jsp?id="<%=jemaah.getJemPoscode()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    ...
                                    <p>الأَصْلُ فِي الأَشْيَاءِ الإِبَاحَة</p>
                                    <p>Maksudnya: Asal bagi sesuatu perkara adalah harus. (Rujuk Al-Asybaah wal-Nazhair, Al-Suyuthi (1/133).</p>
                                </div>
            ...
            <div class="gtco-section">
                <form class="example" action="searchLokasi.jsp" style="margin:auto;max-width:300px">
                    <input type="text" placeholder="Masukkan Poskod Anda" name="search2">
                ...
                <% if (locAll.size() <= 0) {
                    ...
                    <h3 style="margin-left: 40%;">Tiada masjid yang ditemui!</h3>
                    <%} else {
                    %>
                <div class="gtco-container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href=infoJemDetails.jsp?id="<%=locAll.get(i).getLokasiId()%>" class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"></div>
                                    <img width="350" height="250" src="/FridayPrayer/imgLoc/image.jsp?id='<%=locAll.get(i).getLokasiId()%>'">
                                </figure>
                                <div class="fh5co-text">
                                    <h2 style="text-align: center;"><%=locAll.get(i).getNamaMasjid()%></h2>
                                    <p style="text-align: center;">Mukim: <%=locAll.get(i).getMukim()%></p>
                                    <p style="text-align: center;">Daerah: <%= locAll.get(i).getDaerah()%></p>
                                    <p style="text-align: center;">Tarikh Info: <%=ft1.format(c.getTime())%></p>
                                </div>
                            </a>
                        </div>
                        <%}%>
