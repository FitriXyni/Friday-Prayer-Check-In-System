                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=reportList1.jsp?id="<%=laporan.getLokasiId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
            ...
            <div class="gtco-section">
                <div class="gtco-container">
                    <div class="row">
                            ...
                            <a style="margin-left: 50%;" href=reportList1.jsp?id="<%=laporan.getLokasiId()%>"><button class="btn btn-primary">Selesai</button></a>
