                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="serviceAJK.jsp">Back <em>.</em></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    ...
                                    <h1 class="cursive-font">Manage Your Account!</h1>	
                                </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 class="cursive-font">Choose Your Task</h3>
                                                    <form action="updateAJKacc.jsp">
                                                        <div class="row form-group">
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row form-group">
                                                                        <div class="col-md-12">
                                                                            <input type="submit" class="btn btn-primary btn-block" value="Update Your Account">
                                                                        </div>
                                                                    </div>
                                                                    </form>
                                                                    <form action="deleteAJK.jsp">
                                                                        <div class="row form-group">
                                                                            <div class="col-md-12">
