...
<html>
    ...
    <%
        ...
        List<lokasi> locAll = lokDao.retrieveLokasiJemaah1(poskod, kuodate);
        ...
        <div id="page">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="./menuMasjid.jsp?jemPos=<%=jemaah.getJemPoscode()%>&search2=<%=ft1.format(c.getTime())%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
            ...
            <div class="gtco-section">
                <form class="example" action="searchLokasi3.jsp" style="margin:auto;max-width:500px">
                    <input type="text" placeholder="Carian poskod, Daerah, Mukim anda" name="search2">
