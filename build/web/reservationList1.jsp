...
<html>
    ...
    <%
        ...
        List<tempahan> tempAll = tempDao.retrieveJemTem(jemId);
        ...
        <div id="page">
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">Rekod Tempahan Slot!</h1>
            ...
            <div class="gtco-section">
                <% if (tempAll.size() <= 0) {
                    ...
                    <%} else {
                    %>
                <table style="background-color: #faf3f3; margin-left: auto; margin-right: auto; width: 50%;" border='1'>
                    <tr>

                        <th style="text-align: center;">Tarikh Tempahan</th>
                        <th style="text-align: center;">Nama Jemaah</th>
                        <th style="text-align: center;">Perincian Tempahan</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <% if (tempAll.get(i).getTempDate().equals(ft1.format(c.getTime()))){%>

                        <td style="text-align: center;"><a href=reservationDetails1.jsp?id="<%=tempAll.get(i).getTempId()%>"><center><i style="color: #f21170; font-size: 28px;" class="fas fa-eye"></i></center></a>



                            <%} else {%>
                        <td style="text-align: center;"><a href=reservationDetails2.jsp?id="<%=tempAll.get(i).getTempId()%>"><center><i style="color: #f21170; font-size: 28px;" class="fas fa-eye"></i></center></a>
                                    <%}%>
                        </td>
                    </tr>
                    <%}%>
