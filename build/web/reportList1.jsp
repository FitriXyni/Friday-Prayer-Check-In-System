...
<html>
	...
	<title>Rekod Laporan Masjid</title>
	...
	<![endif]-->
       ...
       <%
        ...
        List<laporan> lapAll = lapDao.retrieveLap(lokasiId);
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
                                    <div id="gtco-logo"><a href="./pjaMosList.jsp?daerah=<%=pja.getPjaDaerah()%>&mukim=<%=pja.getPjaMukim()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
				</div>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1 class="cursive-font">Rekod Laporan Solat Jumaat</h1>	
						</div>
	...
	<div class="gtco-section">
		 ...
		 <table style="background-color: #faf3f3; margin-left: auto; margin-right: auto; width: 50%;" border='1'>
                <tr>
                    ...
                    <th style="text-align: center;">Perincian Laporan</th>
                </tr>
                <% if (lapAll.size() <= 0) {
                    %>
                ...
                <% for (int i = 0; i < lapAll.size(); i++) {%>
                <tr>
                   
                    <td style="text-align: center;"><%=lapAll.get(i).getLapDate()%></td>
                    <td style="text-align: center;"><%=lapAll.get(i).getNamaMasjid()%></td>
                    <td style="text-align: center;"><a href=reportDetails1.jsp?id="<%=lapAll.get(i).getLaporanId()%>"><center><i style="color: #f21170; font-size: 20px;" class="fas fa-clipboard"></i></center></a>
