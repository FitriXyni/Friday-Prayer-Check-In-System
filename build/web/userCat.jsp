                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="mainpage.jsp"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">بِسْــــــــــــــــــمِ اللهِ الرَّحْمَنِ الرَّحِيْمِ</h1>
                                    <p>Terima Kasih kerana sudi mendaftarkan diri Tuan/Encik untuk menggunakan sistem ini.</p>
                                    <p>"Friday Prayer Check In System"</p>
                                </div>
                ...
                <div class="gtco-container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                            <h2 class="cursive-font primary-color">Pilih Peranan Anda!</h2>
                        </div>
                    </div>
                    <div class="row text-center">

                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href="registerJemaah.jsp" class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"></i></div>
                                    <img src="images/p2.png" alt="Image" class="img-responsive">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href="registerJemaah2.jsp" class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"></i></div>
                                    <img src="images/p2.png" alt="Image" class="img-responsive">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href="registerPJA.jsp" class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"></div>
                                    <img src="images/p3.png" alt="Image" class="img-responsive">
                                </figure>
                                <div class="fh5co-text">
                                    <p>Pegawai Jabatan Agama</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href="testMasList.jsp" class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"></div>
                                    <img src="images/p3.png" alt="Image" class="img-responsive">
                                </figure>
