            ...
            <div class="gtco-section">
                ...
                <table style="background-color: #faf3f3; margin-left: auto; margin-right: auto; width: 50%;" border='1'>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><a href=reservationDetails3.jsp?id="<%=tempAll.get(i).getTempId()%>"><center><i style="color: #f21170; font-size: 28px;" class="fas fa-eye"></i></center></a>



                            <%} else {%>
                        <td style="text-align: center;"><a href=reservationDetails.jsp?id="<%=tempAll.get(i).getTempId()%>"><center><i style="color: #f21170; font-size: 28px;" class="fas fa-eye"></i></center></a>
                                    <%}%>
                        </td>
                    </tr>
                    <%}%>
