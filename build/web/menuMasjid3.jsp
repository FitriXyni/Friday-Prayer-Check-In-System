    ...
    <body>
        ...
        <div id="page">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="serviceWargasing.jsp">Back <em>.</em></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    ...
                                    <a href=reservationList1.jsp?id="<%=wargasing.getwId()%>"><button class="btn btn-primary">History Reservation</button></a>
                                </div>
            ...
            <div class="gtco-section">
                <form class="example" action="searchLokasi4.jsp" style="margin:auto;max-width:300px">
