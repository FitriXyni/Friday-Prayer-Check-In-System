                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=reservationList1.jsp?id="<%=tempahan.getJemId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    ...
                                    <h1 style="text-align: center;" class="cursive-font">Alhamdulillah!</h1>

                                    <p style="text-align: center;">Tempahan Slot Berjaya</p>
                                    <p style="text-align: center;">مَنْ تَرَكَ ثَلاَثَ جُمَعٍ تَهَاوُنًا بِهَا طَبَعَ اللَّهُ عَلَى قَلْبِهِ</p>
                                    ...
                                    <p style="text-align: center; color: yellow;">Sila "Tangkap Skrin" Info Tempahan Slot Untuk Memudahkan proses masuk ke masjid</p>
                                    <p style="text-align: center; color: yellow;">"Pembatalan Tempahan Slot SEBELUM hari Jumaat"</p>
                                    <% if (ft.format(dNow).equals("Sun")) {%>


                                    <p align="center"><button style="width: 65%;" onclick="alert('Proses Pembatalan tidak berjaya!!!!');" class="btn btn-primary btn-block">Batal Tempahan</button></p>


                                                    <%} else {%>


                                                    <a href=deleteReservation.jsp?id="<%=tempahan.getTempId()%>"><p align="center"><button style="width: 65%;" class="btn btn-primary btn-block">Batal Tempahan</button></p></a>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <p style="text-align: center;"><img src="/FridayPrayer/images/download.png" width="75" height="60"></p>
                                                    <h3 style="text-align: center;" class="cursive-font">Info Tempahan Slot</h3>
                                                    <h2 style="text-align: center; font-weight: 550;">ID Tempahan: <%=tempahan.getTempId()%></h2>
                                                    <img width="200" height="120" style="margin-left: 12%;" src="/FridayPrayer/imgLoc/image.jsp?id='<%=tempahan.getLokasiId()%>'">
                                                    <form action="reservationList1.jsp">
                                                        <input type="hidden" name="id" value="<%=jemaah.getJemId()%>">
                                                        <p style="text-align: center;" class="cursive-font"><%=tempahan.getNamaMasjid()%></p>
                                                        <p style="text-align: left;">No IC: <%=tempahan.getJemIC()%></p>
                                                        <p style="text-align: left;">Nama: <%=tempahan.getJemname()%></p>
                                                        <p style="text-align: left;">No Telefon: <%=tempahan.getJemTel()%></p>
                                                        <p style="text-align: left;">Tarikh : <%=tempahan.getTempDate()%></p>
                                                        <br>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="submit" class="btn btn-primary btn-block" value="Selesai">
                                                            </div>
                                                        </div>
