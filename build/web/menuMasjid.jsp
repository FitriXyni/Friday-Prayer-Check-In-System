...
<html>
    ...
    <%
        ...
        String poskod = request.getParameter("jemPos");
        String kuodate = request.getParameter("search2");
    ...
    <body>
        <%
            ...
            String reservedenied = (String) session.getAttribute("deniedReserve");
            
            if (reservedenied != null){
        %>
        ...
        <div id="page">
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">Tempahan Slot!</h1>
                                    <a href=reservationList1.jsp?id="<%=jemaah.getJemId()%>"><button class="btn btn-primary">Rekod Tempahan</button></a>
                                </div>
            ...
            <div class="gtco-section">
                <form class="example" action="searchLokasi3.jsp" style="margin:auto;max-width:500px">
                    <input type="text" placeholder="Carian Poskod, Daerah, Mukim" name="search2">
                ...
                <div class="gtco-container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                            <h2 class="cursive-font primary-color">Senarai Masjid</h2>
                            <p>Sila patuhi SOP yang telah ditetapkan oleh Majlis Keselamatan Negara (MKN) iaitu memakai pelitup muka, membawa sejadah sendiri bersaiz besar
                             dan satu meter perjarakkan sosial.</p>
                        </div>

                    </div>
                    <% if (locAll.size() <= 0) {
                    %>
                    <i style="margin-left: 43.5%; font-size: 150px; color: red;" class="fas fa-binoculars"></i>
                    <p align="center">Carian dilakukan dengan sangat teliti tapi</p>
                    <h1 class="cursive-font" style="margin-left: 31%;">Tiada masjid yang ditemui!</h1>
                    <%} else {
                    %>
                    <div class="row">
                        ...
                        %>
                            ...
                            <a href="#" onclick="alert('Harap maaf, kuota sudah penuh');" class="fh5co-card-item">
                                ...
                                <div class="fh5co-text">
                                    ...
                                    <p>Daerah: <%= locAll.get(i).getDaerah()%> || Mukim:<%= locAll.get(i).getMukim()%></p>
                                    <p><%=ft2.format(dNow)%></p>
                                    <p><span class="price cursive-font">Kuota Penuh</span></p>
                            ...
                            %>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href=reserveSlot.jsp?id="<%=locAll.get(i).getLokasiId()%>" class="fh5co-card-item">

                                <figure>
                                    <div class="overlay"><i class="ti-plus"></i></div>
                                    <img style="height: 100%; width: 100%;" src="/FridayPrayer/imgLoc/image.jsp?id='<%=locAll.get(i).getLokasiId()%>'" class="img-responsive">
                                </figure>
                                <div class="fh5co-text">
                                    <h2><%=locAll.get(i).getNamaMasjid()%></h2>
                                    <p>Poskod: <%= locAll.get(i).getPoskod()%></p>
                                    <p>Daerah: <%= locAll.get(i).getDaerah()%> || Mukim:<%= locAll.get(i).getMukim()%></p>
                                    <p><%=ft2.format(dNow)%></p>
                                    <p><span class="price cursive-font"><%= reserveSlot.get(a).getTotalTem()%>/ <%= locAll.get(i).getKuotaProv()%> </span>&nbsp;<i style="font-size: 27px; color: #A9294F;" class="fas fa-user"></i></p>
