...
<html>
    ...
    <%
        ...
        List<lokasi> locAll = lokDao.retrieveLokasiAjk1(poskod);
    ...
    <body>
        ...
        <div id="page">
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">Carian Masjid!</h1>
            ...
            <div class="gtco-section">
                <form class="example" action="searchLokasi2.jsp" style="margin:auto;max-width:500px">
                ...
                <% if (locAll.size() <= 0) {
                    ...
                    <h1 class="cursive-font" style="margin-left: 38%;">Tiada masjid yang ditemui!</h1>
                    <%} else {
                    %>
                <div class="gtco-container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href=registerAJKMasjid.jsp?id=<%=locAll.get(i).getLokasiId()%> class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"></div>
                                ...
                                <div class="fh5co-text">
                                    ...
                                    <p>Mukim: <%=locAll.get(i).getMukim()%></p>
                                    <p>Daerah: <%= locAll.get(i).getDaerah()%></p>
