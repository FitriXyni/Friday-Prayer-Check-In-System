...
<%@page import="project.ajkmasjid, project.lokasi, project.DBConnection"%>
...
<html>
    <head>
        ...
        <title>Senarai Ahli Jawatan Kuasa Masjid</title>
    ...
    <%
        int lokasiId = Integer.parseInt(request.getParameter("id"));

        DBConnection database = new DBConnection();
        List<ajkmasjid> ajkAll = ajkDao.retrieveLocAJKMasjid(lokasiId);
        List<ajkmasjid> allAjk = ajkDao.totalAJKM1(lokasiId);
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=ajklistPJA.jsp?id="<%=pja.getPjaId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                    ...
                    <div class="row1">
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em2">
                                <h1 style="text-align: center; color: bisque;">Senarai AJK Masjid Bertugas</h1>
                                ...
                                <div class="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInUp">
                                    <div style="margin-left: 20em;" class="feature-center">
                                        <span style="color: white; margin-left: 2em;" class="counter js-counter" data-from="0" data-to="<%=allAjk.get(i).getTotalAJKMasjid()%>" data-speed="5000" data-refresh-interval="50">1</span>
                                        <span style="color: white; margin-left: 6em;" class="counter-label">AJK Masjid</span>
                                    </div>
                                </div>
                                <%}%>
                            ...
                            <table id="myfrm" style="background-color: #faf3f3; margin-left: auto; margin-right: auto; width: 100%;" border='1'>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">AJK Id</th>
                                    <th style="text-align: center;">Nama AJK</th>
                                ...
                                <% for (int i = 0; i < ajkAll.size(); i++) {%>
                                <tr>
                                    <td style="text-align: center;"><%=i + 1%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkid()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkname()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkic()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkage()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkdob()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkalmt()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkmukim()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkdaerah()%></td>
                                    <td style="text-align: center;"><%=ajkAll.get(i).getAjkntel()%></td>
