                ...
                <div class="gtco-container">
                    <div class="row1">
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <form id="myfrm" action="processKehadiranJemaah.jsp" method="post">
                                ...
                                <table id="myfrm" style="background-color: #faf3f3; margin-left: auto; margin-right: auto; width: 100%;" border='1'>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><%=tempAll.get(i).getStatusKehadiran()%></td>
                                ...
                                <div class="row row-mt-15em"></div>
                                <p align="center"><input type="submit" class="btn btn-primary btn-block" style="width: 20%" onclick="myPrint('myfrm')" value="Cetak"></p>
                                <script>
