...
<html>
    <head>
        ...
        <title>Padam Masjid Berdaftar</title>
    ...
    <%
        ...
        lokasi lokasi = loDao.retrieveOneLokasi(lokasiId);
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=locList.jsp?id="<%=lokasi.getLokasiId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 style="text-align: center;" class="cursive-font">Padam Lokasi Masjid</h1>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font">Pasti untuk meneruskan proses ini?</h3>
                                                    <form action="processDL.jsp" method="post">
                                                        
                                                         <img width="200" height="120" style="margin-left: 12%;" src="/FridayPrayer/imgLoc/image.jsp?id='<%=lokasi.getLokasiId()%>'">
                                                        <input type="hidden" value="<%=lokasi.getLokasiId()%>" name="lokasiId">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <form action="locList.jsp" method="post">
                                                         <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="hidden" value="<%=lokasi.getLokasiId()%>" name="id">
