...
<%@page import="project.pja, project.DBConnection"%>
<jsp:useBean id="pjaDao" class="project.pjaDAO" scope="request"/>
<!DOCTYPE HTML>
...
<html>
    <head>
        ...
        <title>Info Pegawai Jabatan Agama</title>
    ...
    <%
        String pjaId = request.getParameter("id");
        DBConnection database = new DBConnection();
        pjaDAO loDao = new pjaDAO();
        pja pja = loDao.retrievePja(pjaId);
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 style="text-align: center;" class="cursive-font">Info Pegawai Jabatan Agama!</h1>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font">Perincian Pegawai Jabatan Agama</h3>

                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label>Nama Pegawai Jabatan Agama</label>
                                                            <input type="text" name="pjaName" value="<%=pja.getPjaName()%>" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label>Nombor Telefon</label>
                                                            <input type="text" name="pjaNTel" value="<%=pja.getPjantEL()%>" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label>Nombor Kad Pengenalan</label>
                                                            <input type="text" name="pjaIC" value="<%=pja.getPjaIC()%>" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label>Mukim Bertugas</label>
                                                            <input type="text" name="pjaIC" value="<%=pja.getPjaMukim()%>" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label>Daerah Bertugas</label>
                                                            <input type="text" name="pjaIC" value="<%=pja.getPjaDaerah()%>" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <a href=updatePJA.jsp?id="<%=pja.getPjaId()%>"><input type="button" class="btn btn-primary btn-block" value="Kemaskini"></a>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <input type="hidden" name="pjaId" value="<%=pja.getPjaId()%>">
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <a href="servicePJA.jsp"><input type="button" class="btn btn-primary btn-block" value="Selesai"></a>
                                                        </div>
                                                    </div>
