                    ...
                    <div class="row1">
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em2">
                                <h1 style="text-align: center; color: bisque;">Senarai Kehadiran Jemaah</h1>
                            ...
                            <form action="processKehadiranJemaah.jsp" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <input type="radio" name="status<%=(i + 1)%>" value="Hadir">
                                                    <label><i style="color: greenyellow; font-size: 18px;" class="fas fa-check-circle"></i></label>
                                                    <input type="radio" name="status<%=(i + 1)%>" value="Tidak Hadir">
                                                    <label><i style="color: red;font-size: 18px;" class="fas fa-times-circle"></i></label>
                                                    <input type="hidden" name="tempId<%=(i + 1)%>" value=<%=tempAll.get(i).getTempId()%>>
                                ...
                                <div class="row row-mt-15em"></div>
                                <p align="center"><input type="submit" class="btn btn-primary btn-block" style="width: 20%" value="Simpan"></p>
                            </form>
