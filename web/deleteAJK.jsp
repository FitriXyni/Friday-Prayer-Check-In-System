                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="manAJKacc.jsp">Back <em>.</em></a></div>
                        </div>
                        <div class="col-xs-8 text-right menu-1">
                            <ul>
                                <li class="btn-cta"><a href="index.html"><span>Log Out</span></a></li>
                            </ul>	
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    ...
                                    <h1 class="cursive-font">Thank You <%=ajkmasjid.getAjkname()%>!</h1>	
                                </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 class="cursive-font">Are Sure want to delete your account?</h3>
                                                    <form action="processDAjk.jsp">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row form-group">
                                                                        <div class="col-md-12">
                                                                            <input type="submit" class="btn btn-primary btn-block" value="Yes, Sure!">
                                                                        </div>
                                                                    </div>
                                                                    </form>
                                                                    <form action="ManAccJem.html">
                                                                        <div class="row form-group">
                                                                            <div class="col-md-12">
                                                                                <input type="submit" class="btn btn-primary btn-block" value="Cancel">
                                                                            </div>
                                                                        </div>
                                                                    </form>	
                                                                </div>
