                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="index.html">SISTEM FPCI <em>.</em></a></div>
                        </div>
                        <div class="col-xs-8 text-right menu-1">
                            <ul>
                                ...
                                <li class="has-dropdown">
                                    <a href="#">Bahasa</a>
                                    <ul class="dropdown">
                                        <li><a href="mainpage.jsp">Bahasa Inggeris</a></li>
                                        <li><a href="lamanUtama.jsp">Bahasa Melayu</a></li>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    ...
                                    <h1 class="cursive-font">Baik-Baik Sahaja!</h1>	
                                </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 class="cursive-font">Borang Log Masuk</h3>
                                                    <form action="process-signin.jsp" method="post">
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Kategori</label><br>
                                                                <input type="radio" name="type" value="jemaah">
                                                                <label>Jemaah Tempatan</label><br>
                                                                <input type="radio" name="type" value="jemaah1">
                                                                <label>Jemaah Luar</label><br>
