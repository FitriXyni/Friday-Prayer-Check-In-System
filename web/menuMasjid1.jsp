...
<html>
    ...
    <%
        ...
        List<tempahan> tempAll = tempDao.reserveSlot(poskod, kuodate);
    ...
    <body>
        ...
        <div id="page">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="servicePJA.jsp">Back <em>.</em></a></div>
                        </div>
            ...
            <div class="gtco-section">
                <form class="example" action="searchLokasi1.jsp" style="margin:auto;max-width:300px">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <% for (int i = 0; i < tempAll.size(); i++) {
                            ...
                            int lokasiId = tempAll.get(i).getLokasiId();
                            
                            List<tempahan> reserveSlot = tempDao.totalTempahan(lokasiId);
                            
                            database.closeConnection();
                        %>

                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <a href=reserveSlot.jsp?id="<%=tempAll.get(i).getLokasiId()%>" class="fh5co-card-item">
                                <figure>
                                    <div class="overlay"><i class="ti-plus"></i></div>
                                    <img width="350" height="250" src="/FridayPrayer/imgLoc/image.jsp?id='<%=tempAll.get(i).getLokasiId()%>'" class="img-responsive">
                                </figure>
                                <div class="fh5co-text">
                                    <h2><%=tempAll.get(i).getNamaMasjid()%></h2>
                                    <p>Poskod: <%= tempAll.get(i).getPoskod()%></p>
                                    <p><span class="price cursive-font"><%= reserveSlot.get(i).getTotalTem()%> / <%= tempAll.get(i).getKuotaProv()%> </span></p>
                                </div>
                            </a>
                        </div>
                        <%}%>
