    ...
    <body>
        ...
        <div id="page">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=reservationList.jsp?id="<%=jemaah.getJemId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
            ...
            <% if (infoAll.size() <= 0) {
                    ...
                    out.println("alert(\"Sila Masukkan Info Solat Jumaat Masjid Anda!!!\")");
                    out.println("</script >");
