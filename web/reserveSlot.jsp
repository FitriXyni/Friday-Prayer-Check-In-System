...
<html>
    <head>
        ...
        <title>Tempahan Slot Jemaah</title>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 style="text-align: center;" class="cursive-font">Tempahan Slot!</h1>
                                    <p style="text-align: center;">وَلاَ تَذَرُوا فُرُجَاتٍ لِلشَّيْطَانِ وَمَنْ وَصَلَ صَفًّا وَصَلَهُ اللَّهُ وَمَنْ قَطَعَ صَفًّا قَطَعَهُ اللَّهُ</p>
                                    <p style="text-align: justify;">Maksudnya: “Janganlah kamu biarkan kekosongan (saf) itu untuk syaitan. Sesiapa yang menyambungkan saf Allah akan menyambungkannya. Sesiapa yang memutuskan saf, Allah akan memutuskan dirinya.”

                                        Riwayat Abu Daud (666)</p>
                                </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font">Perincian Tempahan Slot</h3>
                                                    <form action="processRS.jsp" method="post">
                                                        <input type="hidden" name="jemId" value="<%=jemaah.getJemId()%>" class="form-control">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="submit" class="btn btn-primary btn-block" value="Tempah Sekarang">
                                                            </div>
                                                        </div>
                                                    </form>	
                                                </div>
