...
<html>
    <head>
        ...
        <title>Kemaskini Profile Jemaah</title>
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" name="jempass" value="<%=jemaah.getJemPass()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <label>No Kad Pengenalan:</label>
                                                                    <input type="text" id="jemic" name="jemic" onblur="getIc()" value="<%=jemaah.getJemIC()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <label>Umur:</label>
                                                                    <input type="text" name="jemage" id="jemage" value="<%=jemaah.getJemAge()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <label>Tarikh Lahir:</label>
                                                                    <input type="text" id="jemdob" name="jemdob" value="<%=jemaah.getJemDOB()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <label>Alamat:</label>
                                                                    <input type="text" name="jemalamat" value="<%=jemaah.getJemAlamat()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <label>Mukim:</label>
                                                                    <input type="text" name="jemmukim" value="<%=jemaah.getJemMukim()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <label>Daerah:</label>
                                                                    <input type="text" name="jemdaerah" value="<%=jemaah.getJemDaerah()%>" class="form-control" required>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <select id="jemCategory" name="jemCat" value="<%=jemaah.getJemCat()%>" class="form-control" required>
                                                                        <option value="tempatan">Jemaah Tempatan</option>
                                                                        <option value="luar">Jemaah Luar</option>
