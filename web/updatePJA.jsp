...
<html>
    <head>
        ...
        <title>Kemaskini Pegawai Jabatan Agama</title>
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=pjaInformation.jsp?id="<%=pja.getPjaId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    ...
                                                    <form action="processUpdatePJA.jsp" method="post">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" name="pjaname" value="<%=pja.getPjaName()%>" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Kata Laluan</label>
                                                                <input type="text" name="pjapass" value="<%=pja.getPjaPass()%>" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Nombor Telefon</label>
                                                                <input type="text" name="pjantel" value="<%=pja.getPjantEL()%>" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Nombor Kad Pengenalan</label>
                                                                <input type="text" name="pjaic" value="<%=pja.getPjaIC()%>" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Daerah Bertugas</label>
                                                                <input type="text" name="pjadaerah" value="<%=pja.getPjaDaerah()%>" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Mukim Bertugas</label>
                                                                <input type="text" name="pjamukim" value="<%=pja.getPjaMukim()%>" class="form-control" required>
                                                            </div>
                                                        </div>
