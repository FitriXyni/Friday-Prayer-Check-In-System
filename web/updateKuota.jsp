                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=kuotaInfo.jsp?id="<%=ajkmasjid.getAjkid()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 style="text-align: center;" class="cursive-font">Kemas Kini Kuota!</h1>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font"><%=ajkmasjid.getNamaMasjid()%></h3>
                                                    <form action="processAK.jsp">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="number" name="kuotaPrd" value="<%=ajkmasjid.getKuotaProv()%>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Tarikh tersedia:</label>
                                                                <input type="text" name="kuotadate" value="<%=ft1.format(c.getTime())%>" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <input type="hidden" name="lokasiId" value="<%=ajkmasjid.getLokasiId()%>">
                                                        </div>    
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
