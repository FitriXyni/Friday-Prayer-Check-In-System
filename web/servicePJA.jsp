...
<html>
    <head>
        ...
        <title>Perkhidmatan Pegawai Jabatan Agama</title>
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="servicePJA.jsp">FPCI SYSTEM <em>.</em></a></div>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">Assalamualaikum <%=pja.getPjaName()%> !</h1>
            ...
            <div id="gtco-features">
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href="addLocation.jsp">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href="./pjaMosList.jsp?daerah=<%=pja.getPjaDaerah()%>&mukim=<%=pja.getPjaMukim()%>">
                         ...
                         <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href=pjaInformation.jsp?id="<%=pja.getPjaId()%>">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href=ajklistPJA.jsp?id="<%=pja.getPjaId()%>">
                                        <i style="color: black;" class="fas fa-clipboard-list"></i>
                                    </a>
                                </span>
                                <h3>Senarai AJK Masjid</h3>
                            </div>
                        </div>
                    </div>
                </div>
