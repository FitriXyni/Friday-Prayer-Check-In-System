                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="./masList1.jsp?daerah=<%=pja.getPjaDaerah()%>&mukim=<%=pja.getPjaMukim()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-15em1">
                                <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 style="text-align: center;" class="cursive-font">Info Lokasi Masjid</h1>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 style="text-align: center;" class="cursive-font"><%=lokasi.getNamaMasjid()%></h3>
                                                    
                                                        
                                                        <img width="200" height="120" style="margin-left: 12%;" src="/FridayPrayer/imgLoc/image.jsp?id='<%=lokasi.getLokasiId()%>'">

                                                       <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Latitud Masjid:</label>
                                                                <input type="text" name="latitude" value="<%=lokasi.getLatitude()%>" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Longitud Masjid:</label>
                                                                <input type="text" name="longitude" value="<%=lokasi.getLongitude()%>" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Poskod:</label>
                                                                <input type="text" name="poscode" value="<%=lokasi.getPoskod()%>" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Daerah:</label>
                                                                <input type="text" name="daerah" value="<%=lokasi.getDaerah()%>" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label>Mukim:</label>
                                                                <input type="text" name="mukim" value="<%=lokasi.getMukim()%>" class="form-control" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <a href=updateLoc.jsp?id=<%=lokasi.getLokasiId()%>><input type="button" class="btn btn-primary btn-block" value="Kemaskini"></a>
                                                            </div>
                                                        </div>
                                                            <div class="row form-group">
                                                                <input type="hidden" name="lokasiId" value="<%=lokasi.getLokasiId()%>">
                                                            </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                  <a href=deleteLoc.jsp?id=<%=lokasi.getLokasiId()%>><input type="button" class="btn btn-primary btn-block" value="Padam"></a>
                                                            </div>
                                                        </div>
