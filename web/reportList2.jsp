...
<html>
    <head>
        ...
        <title>Rekod Laporan Solat Jumaat</title>
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=addReport.jsp?id="<%=ajkmasjid.getAjkid()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
            ...
            <div class="gtco-section">
                ...
                <table style="background-color: #faf3f3; margin-left: auto; margin-right: auto; width: 50%;" border='1'>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><a href=reportDetails.jsp?id="<%=lapAll.get(i).getLaporanId()%>"><center><i style="color: #f21170; font-size: 20px;" class="fas fa-clipboard"></i></center></a>
