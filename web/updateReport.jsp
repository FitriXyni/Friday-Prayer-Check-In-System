...
<html>
    <head>
        ...
        <title>Perincian Laporan Solat Jumaat</title>
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=reportDetails.jsp?id="<%=laporan.getLaporanId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                    ...
                    <div class="row">
                        <form action="updateReport" method="post" enctype="multipart/form-data">
                            <div class="col-md-12" style="margin-left: 2em;">
                                ...
                                <div class="col-md-6 animate-box">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="imamName" value="<%=laporan.getLapIM()%>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <label>Nama Bilal:</label>
                                            <input type="text" name="BilalName" value="<%=laporan.getLapB()%>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="repDesc" id="message" cols="20" rows="20" class="form-control"><%=laporan.getLapDesc()%></textarea>
                                        </div>
                                    </div>
                                    <p>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="date" name="dateRep" value="<%=laporan.getLapDate()%>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <input type="hidden" name="laporanId" value="<%=laporan.getLaporanId()%>" class="form-control">
                                ...
                                <div class="col-md-5 col-md-push-1 animate-box">
                                    ...
                                    <div class="gtco-contact-info">
                                        ...
                                        <label style="color: red;">Sila Masukkan Gambar Laporan Anda</label>
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                <label>Gambar 1:</label>
                                                <input type="file" id="myfile" name="gam1" onchange="readURL(this)" required> 
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="file" id="myfile" name="gam2" onchange="readURL1(this)" required>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="file" id="myfile" name="gam3" onchange="readURL2(this)" required>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="file" id="myfile" name="gam4" onchange="readURL3(this)" required>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="file" id="myfile" name="gam5" onchange="readURL4(this)" required>
                            ...
                            <div class="form-group">
                                <input style="margin-left: 50%;" type="submit" value="Kemaskini Sekarang" class="btn btn-primary">
                            </div>
