    ...
    <body>
        ...
        <div id="page">
            ...
            <div class="gtco-section">
                <form class="example" action="menuMasjid.jsp" style="margin:auto;max-width:300px">
                        <input type="date" placeholder="Choose Date" name="search2" class="form-control">
                        <input type="hidden" align="center" value="<%=jemaah.getJemPoscode()%>" name="jemPos"/>
