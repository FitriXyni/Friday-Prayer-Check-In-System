                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href=reservationList.jsp?id="<%=tempahan.getJemId()%>"><i style="font-size: 40px;" class="fas fa-arrow-circle-left"></i></a></div>
                        </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <img style="margin-left: 6.5em;" src="/FridayPrayer/images/download.png" width="75" height="60">
                                                    ...
                                                    <form action="reservationList.jsp">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="submit" class="btn btn-primary btn-block" value="Okay">
                                                            </div>
                                                        </div>
