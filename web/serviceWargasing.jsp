                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="mainpage.jsp">Home <em>.</em></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-center">
                            ...
                            <div class="row row-mt-15em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1 class="cursive-font">Assalamualaikum <%=wargasing.getwName()%> !</h1>	
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><% if (ft.format(dNow).equals("Mon") || ft.format(dNow).equals("Wed") || ft.format(dNow).equals("Thu") || ft.format(dNow).equals("Fri")) {%>

                                    <a href="./menuMasjid3.jsp?jemPos=<%=wargasing.getwPoscode()%>&search2=<%=ft1.format(c.getTime())%>">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href=addReport.jsp?id="<%=wargasing.getwId()%>">
                                        <i class="ti-truck"></i>
                                    </a>
                                </span>
                                <h3>Add Report</h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span class="icon"><a href="serviceAJKK.jsp">
                                        <i class="ti-truck"></i>
                                    </a>
                                </span>
                                <h3>Manage Module</h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                <span  class="icon"><a href=addFPI.jsp?id="<%=wargasing.getwId()%>">
                                        <i class="ti-thought"></i>
                                    </a>
                                </span>
                                <h3>Add Friday Prayer Information</h3>
                            </div>
                        </div>
